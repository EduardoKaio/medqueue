...
export default function Home() {
  return (
    <div>
      ...
      {/* Conteúdo principal */}
      <main 
        style={{ height: "80vh", backgroundColor: "#FF8F00", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "2rem 4rem"}}>
          {/* Texto à esquerda */}
          <AnimatedSection
            direction="up"
      ...
      <AnimatedSection onMouseEnter={e => e.currentTarget.style.transform = "translateY(-20px)"} onMouseLeave={e => e.currentTarget.style.transform = "translateY(0)"} direction="up" style={{
        ...
        maxWidth: "1000px",
        width: "100%",
        boxShadow: "0px 0px 2px rgba(105, 105, 105, 0.1), 0px 20px 0px #FF8F00, 0px 40px 0px #004FA1",
